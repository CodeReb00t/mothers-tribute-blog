...
const Contact = () => {
  ...
  <p className="mb-4">
    Have a story about your mother that you’d like to share? Want to contribute to the blog, send feedback, or simply say hello?
    This tribute was made from the heart—and we’d love to grow it with yours.
  </p>

  <ul className="space-y-2 mb-4">
    <li>📩 <strong>Email:</strong> <a href="mailto:devanshkg19@gmail.com" className="text-blue-600 underline">devanshkg19@gmail.com</a></li>
    <li>📸 <strong>Submit a Story:</strong> Send your story (300–600 words) and optional photo to the email above.</li>
    <li>💡 <strong>Ideas or Suggestions?</strong> We’re open to collaborations, messages, or anything that celebrates motherhood.</li>
  </ul>
